...
export const Icons = {
  ...
  Steps: ({ className = "w-5 h-5" }: IconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="none"
  ...
  Pairs: ({ className = "w-5 h-5" }: IconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="none"
  ...
  Restart: ({ className = "w-5 h-5" }: IconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="none"
  ...
  Trophy: ({ className = "w-6 h-6 text-amber-500" }: IconProps) => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="none"
